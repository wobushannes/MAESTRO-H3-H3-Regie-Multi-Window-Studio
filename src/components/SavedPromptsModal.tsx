...
import { Bookmark, Trash2, Copy, Check, Download, Upload, Search, Film } from 'lucide-react';
      ...
      <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-extrabold text-slate-900 flex items-center gap-2">
            ...
            Gespeicherte Prompts & Multi-Window Setups
          </h2>
      ...
      {savedList.length > 0 && (
        <div className="relative w-full">
          ...
          <input
            ...
            placeholder="Gespeicherte Prompts durchsuchen..."
      ...
      {filtered.length === 0 ? (
        <div className="bg-white border border-dashed border-slate-300 rounded-2xl p-10 text-center space-y-2">
          ...
          <p className="text-sm font-bold text-slate-600">
            Noch keine gespeicherten Prompts vorhanden.
          </p>
            ...
            >
              ...
              <div className="flex items-center gap-2 pt-2 border-t border-slate-100">
                <button
                  ...
                  className="flex-1 py-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold rounded-xl text-xs transition-all shadow-xs"
                >
                  In Builder Laden
                </button>
